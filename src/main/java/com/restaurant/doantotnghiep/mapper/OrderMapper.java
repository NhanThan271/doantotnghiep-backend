        ...
        public static OrderStatusDTO toStatusDTO(Order order) {
                ...
                return OrderStatusDTO.builder()
                                ...
                                .table(order.getTable() != null ? OrderStatusDTO.TableDTO.builder()
                                                ...
                                                .build()
                                                : null)
                                .room(order.getRoom() != null ? OrderStatusDTO.RoomDTO.builder()
                                                .id(order.getRoom().getId())
                                                .number(order.getRoom().getNumber())
                                                .area(order.getRoom().getArea())
                                                .capacity(order.getRoom().getCapacity())
                                                .status(order.getRoom().getStatus() != null
                                                                ? order.getRoom().getStatus().name()
                                                                : null)
                                                .roomFee(order.getRoom().getRoomFee())
                                                .build()
                                                : null)
